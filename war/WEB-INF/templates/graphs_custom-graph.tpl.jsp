...
<div id="graphmenu">
  ...
  <form action="<%=request.getRequestURI()%>">
    <div class="formrow">
      ...
      <label class="startend" for="">start</label>
        <input type="text" name="start"
          value="<%=(request.getParameter("graph") != null &&
                     request.getParameter("graph").equals("platforms") &&
                     request.getParameter("start") != null) ?
                        request.getParameter("start") : ""%>"/>
      <label class="startend" for="">end</label>
        <input type="text" name="end"
          value="<%=(request.getParameter("graph") != null &&
                     request.getParameter("graph").equals("platforms") &&
                     request.getParameter("end") != null) ?
  ...
  <form action="<%=request.getRequestURI()%>">
    <div class="formrow">
      ...
      <label class="startend" for="">start</label>
        <input type="text" name="start"
          value="<%=(request.getParameter("graph") != null &&
                     request.getParameter("graph").equals("versions") &&
                     request.getParameter("start") != null) ?
                        request.getParameter("start") : ""%>"/>
      <label class="startend" for="">end</label>
        <input type="text" name="end"
  ...
  <form action="<%=request.getRequestURI()%>">
    <div class="formrow">
      ...
      <label class="startend" for="">start</label>
        <input type="text" name="start"
          value="<%=(request.getParameter("graph") != null &&
                     request.getParameter("graph").equals("bandwidth") &&
                     request.getParameter("start") != null) ?
                        request.getParameter("start") : ""%>"/>
      <label class="startend" for="">end</label>
        <input type="text" name="end"
