...
public class PlatformsBandwidthBargraphServlet extends HttpServlet {
  ...
  static {
    ...
    log = Logger.getLogger(PlatformsBandwidthBargraphServlet.class);
  }

  public PlatformsBandwidthBargraphServlet()  {
    this.graphName = "platforms-bandwidth-bargraph";
    this.gcontroller = new GraphController(graphName);
    this.rquery = "plot_bandwidth_platforms_bargraph('%s', '%s', '%s')";
